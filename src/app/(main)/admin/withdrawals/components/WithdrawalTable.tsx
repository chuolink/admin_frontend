...
import { type Withdrawal, type WithdrawalResponse } from '@/types/withdrawal';
...
export default function WithdrawalTable({ onAddNew }: WithdrawalTableProps) {
  ...
  const queryParams = useMemo(() => {
    ...
    columnFilters.forEach((filter) => {
      if (
        (filter.id === 'status' || filter.id === 'type') &&
  ...
  const deleteMutation = useMutation({
    ...
    onError: () => toast.error('Failed to delete withdrawal')
  });
    ...
    () => [
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          const email = withdrawal.student?.email || withdrawal.user.email;
          return (
          ...
          return (
            <DropdownMenu>
              ...
              <DropdownMenuContent align='end' className='w-[160px]'>
                ...
                <DropdownMenuItem
                  onClick={() =>
                    router.push(`/admin/withdrawals/${withdrawal.id}/edit`)
                  }
                >
